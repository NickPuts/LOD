...
<style>
  ...
  .FLEX {
    background: linear-gradient(to right, var(--WR) 0%, var(--WR) 33.33%, var(--RB) 33.33%, var(--RB) 66.66%, var(--TE) 66.66%);
  }

  .WRRB {
    background: linear-gradient(to right, var(--WR) 0%, var(--WR) 50%, var(--RB) 50%);
  }

  .S-FLEX {
    background: linear-gradient(to right, var(--WR) 0%, var(--WR) 25%, var(--RB) 25%, var(--RB) 50%, var(--TE) 50%, var(--TE) 75%, var(--QB) 75%);
  }

  .R-FLEX {
    background: linear-gradient(to right, var(--WR) 0%, var(--WR) 50%, var(--TE) 50%);
  }

  .IDP {
    background: linear-gradient(to right, var(--DL) 0%, var(--DL) 33.33%, var(--LB) 33.33%, var(--LB) 66.66%, var(--DB) 66.66%);
  }
